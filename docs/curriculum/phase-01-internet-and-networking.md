...
* Analyze real network traffic using packet capture tools.
...
| ✅      | Packet Capture (Wireshark)                                  | Capture and analyze ICMP, HTTP, HTTPS, TLS, IP, TCP, and Ethernet traffic using Wireshark.                                         |
...
* Captured and analyzed ICMP Echo Request and Echo Reply packets using Wireshark.
* Captured HTTP traffic and observed plaintext application-layer communication.
* Captured HTTPS traffic and observed TLS handshakes and encrypted application data.
* Dissected real packets through Ethernet, IP, TCP, and TLS layers.
